  ...
  <div class="flex">
    ...
    >
      ...
      <nav class="mt-10">
        ...
        <!-- <p class="pl-4 text-xs my-2 font-semibold mb-4 text-gray-400"></p> -->
        <a
          target="_blank"
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Blank' ? activeClass : inactiveClass]"
